...
const interests = [
    { id: 1, text: "Create UI/UX Design" },
    { id: 2, text: "Build Mobile App" },
    { id: 3, text: "Custom Website" },
    { id: 4, text: "Photography" },
    { id: 5, text: "Personal Electric Vehicle" },
];
